        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/ranking" className="text-gray-500 hover:text-emerald-600">
                  Browse Categories
                </Link>
              </li>
              <li>
                <Link href="/top-rated" className="text-gray-500 hover:text-emerald-600">
                  Top Rated Businesses
                </Link>
              </li>
              <li>
                <Link href="/write-review" className="text-gray-500 hover:text-emerald-600">
                  Write a Review
                </Link>
              </li>
              <li>
                <Link href="/how-it-works" className="text-gray-500 hover:text-emerald-600">
                  How it Works
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/get-verified" className="text-gray-500 hover:text-emerald-600">
                  Get Verified
                </Link>
              </li>
              <li>
                <Link href="/business-login" className="text-gray-500 hover:text-emerald-600">
                  Business Login
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/success-stories" className="text-gray-500 hover:text-emerald-600">
                  Success Stories
                </Link>
              </li>
            </ul>
